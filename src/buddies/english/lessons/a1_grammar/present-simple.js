...
import { Check, X, Lightbulb, Train, BookOpen } from 'lucide-react';
...
const PresentSimpleInteractiveGames = () => {
  return (
    <div className="space-y-8 my-8">
      <div>
        ...
        <GrammarGame type="tenseTimeline" />
      </div>
      ...
      <div>
        ...
        <GrammarGame type="sentenceBuilder" data={sentenceBuilderData} />
      </div>
      ...
      <div>
        ...
        <GrammarGame type="verbConjugator" data={verbConjugatorData} />
      </div>
      ...
      <div>
        ...
        <GrammarGame type="fixTheMistake" data={fixTheMistakeData} />
      </div>
      ...
      <div>
        ...
        <GrammarGame type="translateThis" data={translateThisData} />
      </div>
    </div>
  );
};
...
## 🎮 Interaktive Übungen: Lass uns spielen!

Jetzt ist es Zeit, das Gelernte zu üben! Probiere diese interaktiven Übungen aus.

### 🎯 Spiel 1: Zeit-Linie

Zuerst visualisieren wir, wann man welche Zeitform verwendet. Klicke auf die Zeitlinie!

<GrammarGame type="tenseTimeline" />

---

### 🧩 Spiel 2: Satz-Baumeister

Baue korrekte Sätze, indem du die Wörter in die richtige Reihenfolge bringst!

<GrammarGame type="sentenceBuilder" data={sentenceBuilderData} />

---

### 🔧 Spiel 3: Verb-Konjugator

Übe das Konjugieren von Verben! Tippe die richtige Form ein.

<GrammarGame type="verbConjugator" data={verbConjugatorData} />

---

### 🚨 Spiel 4: Fehler finden

Finde den grammatischen Fehler in jedem Satz und klicke darauf!

<GrammarGame type="fixTheMistake" data={fixTheMistakeData} />

---

### 🌍 Spiel 5: Übersetze das

Übersetze diese deutschen Sätze ins Englische mit Present Simple!
