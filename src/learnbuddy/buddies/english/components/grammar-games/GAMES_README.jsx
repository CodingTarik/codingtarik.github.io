...
const GAMES_LIST = [
  ...
  },
  {
    id: 'grammarMatch',
    title: 'Grammar Match',
    description: 'Memory card matching game. Flip cards to find matching grammar pairs like expressions and their tense names.',
    icon: '🃏',
    type: 'Memory / Matching'
  },
  {
    id: 'grammarScramble',
    title: 'Grammar Scramble',
    description: 'Unscramble mixed-up words to form correct sentences. Click the words in the right order!',
    icon: '🔀',
  ...
  },
  {
    id: 'grammarQuiz',
    title: 'Grammar Quiz',
    description: 'Fast-paced multiple choice quiz with a 15-second timer per question. Build streaks for score multipliers!',
    icon: '⚡',
    type: 'Quiz / Speed'
  },
  {
