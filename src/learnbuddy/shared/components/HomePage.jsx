...
function HomePage({ onStartLesson, onStartWarmup }) {
  ...
  return (
    <div className="max-w-2xl mx-auto px-3 sm:px-4 py-4 sm:py-8 mt-4 sm:mt-8">{/* Added top margin for spacing */}

      {/* Hero Section */}
      <div className="text-center mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-4xl font-bold text-stone-800 dark:text-stone-100 mb-3 sm:mb-4">
          {t('welcome')} 🧗
        </h1>
        ...
        <p className="text-base sm:text-lg text-stone-700 dark:text-stone-300 mb-4 sm:mb-6 leading-relaxed px-2">
          {t('welcomeSubtitle')}
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center mb-6 sm:mb-8">
          <button
            ...
            className="bg-teal-500 hover:bg-teal-600 text-white font-bold py-3 sm:py-4 px-6 sm:px-8 rounded-lg shadow-md transition-all transform hover:scale-105"
          >
            <span className="flex items-center justify-center gap-2 text-base sm:text-lg">
              <Mountain size={20} className="sm:w-6 sm:h-6" />
              {t('startLesson')}
            </span>
          </button>
          ...
          <button
            ...
            className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 sm:py-4 px-6 sm:px-8 rounded-lg shadow-md transition-all transform hover:scale-105"
          >
            <span className="flex items-center justify-center gap-2 text-base sm:text-lg">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 mt-8 sm:mt-12">
        <div className="bg-white dark:bg-stone-800 rounded-lg shadow-md p-4 sm:p-6 text-center hover:shadow-lg transition-shadow">
