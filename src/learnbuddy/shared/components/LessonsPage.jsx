...
function LessonsPage({ lessons, onSelectLesson }) {
    ...
    return (
      ...
      >
        ...
        <button
          ...
          className={`w-full p-3 sm:p-4 hover:shadow-md transition-all text-left rounded-lg flex items-center gap-2 sm:gap-3 ${
        ...
        >
          <div className="flex-1 min-w-0">
            <h3 className={`font-bold mb-0.5 sm:mb-1 text-sm sm:text-base ${
              isComplete 
  ...
  return (
    <div className="pb-16 sm:pb-20">
      <h1 className="text-2xl sm:text-3xl font-bold text-stone-800 dark:text-stone-100 mb-4 sm:mb-6 flex items-center gap-2">
        <BookOpen className="text-teal-500 shrink-0" size={24} />
        {t('boulderLessons')}
      </h1>

      {/* Progress Card */}
      <div className="bg-gradient-to-br from-teal-500 to-teal-600 dark:from-teal-600 dark:to-teal-800 rounded-xl shadow-lg p-4 sm:p-6 mb-6 sm:mb-8 text-white relative overflow-hidden">
      ...
      {Object.entries(organizedLessons).map(([categoryId, categoryData]) => {
        ...
        return (
          <div key={categoryId} className="mb-8 sm:mb-10">
            <h2 className="text-lg sm:text-xl font-bold text-stone-800 dark:text-stone-200 border-b-2 border-stone-200 dark:border-stone-700 pb-2 mb-3 sm:mb-4 flex items-center gap-2">
              <span className="bg-teal-100 dark:bg-teal-900 text-teal-700 dark:text-teal-300 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded text-xs sm:text-sm font-bold shadow-sm shrink-0">
