  ...
  return (
    <>
      ...
      <motion.div
        ...
        animate={{ x: 0 }}
        className={`
          fixed left-0 top-0 bottom-0 w-[85vw] max-w-80 bg-background/95 backdrop-blur-xl border-r border-border flex flex-col z-50
      ...
      >
        ...
        {/* Header - Profile */}
        <motion.div
          className="p-3 sm:p-4 border-b border-border text-center"
        ...
        >
          ...
          <motion.div
            className="w-28 h-28 sm:w-40 sm:h-40 mx-auto mb-3 rounded-full bg-gradient-to-br from-primary via-secondary to-primary flex items-center justify-center p-1"
          ...
          {tabs.map((tab, index) => {
            ...
            return (
              <motion.button
                ...
                className={`w-full px-6 py-3 text-left font-medium transition-all flex items-center gap-3 group relative overflow-hidden ${selectedTab === tab.id
                  ? 'text-primary'
