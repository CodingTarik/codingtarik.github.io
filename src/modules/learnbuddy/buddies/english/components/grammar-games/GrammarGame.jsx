...
import GrammarMatch from './GrammarMatch';
import GrammarScramble from './GrammarScramble';
...
function GrammarGame({ type, data, title, description }) {
  ...
  const renderGame = () => {
    ...
    switch (type) {
      ...
      case 'grammarMatch':
        return <GrammarMatch exercises={processedData} language={language} />;

      case 'grammarScramble':
        return <GrammarScramble exercises={processedData} language={language} />;

      case 'grammarQuiz':
        return <GrammarQuiz exercises={processedData} language={language} />;
